...
but_create = InlineKeyboardButton(text="Создать оффер", callback_data="create_offer")


offer_keyboard = InlineKeyboardMarkup(inline_keyboard = [[but_search, but_create], [but_set, but_get], [but_create]])